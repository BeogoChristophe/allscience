    ...
    <div class="collapse navbar-collapse button-container" id="bs-example-navbar-collapse-2" style="background:blue;">
     <div class="div-container">
      <div class="button-container div" style="margin-left:-10px;" >
           ...
           <button class="button" style="width:20%; background-color:blue; top:20px; border-color:#fff;"><a href="se_deconnecter_forum.php">Se déconnecter</a></button>
           <?php else: ?>
           <button class="button" style="width:20%; background-color:blue; top:20px; border-color:#fff;"><a href="s_enregister_forum.php">S'inscrire</a></button>
           <button class="button" style="width:20%; background-color:blue; top:20px; border-color:#fff;"><a href="se_connecter_forum.php" >Se connecter</a></button>
           <?php endif ?>
      </div>
      <div class="dropdown text-end div "  style="margin-left:-10px;">
         <form class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3" style="  margin-left:-70%; float:right; width:20%;" role="search">
          ...
          <ul class="dropdown-menu " style="float:right; margin-right:-70%; width:50% ; background-color: blue; ">
            ...
            <?php if(isset($_SESSION["auth"])):?>
            <li><a class="dropdown-item" style="color: #fff;" href="se_deconnecter_forum.php">Sign out</a></li>
            <?php else: ?>
            <li><a class="dropdown-item" style="color: #fff;" href="s_enregister_forum.php">S'inscrire</a></li>
            <li><a class="dropdown-item" style="color: #fff;" href="se_connecter_forum.php" >Se connecter</a></li>
            <?php endif ?>
          </ul>
        </div>
     </div>
